...
def Crosslink_Pipeline_Dry_Run(
    main_name = "ethanol",                                   # Monomer to polimerize gives PVA ; not vinylic alcohol as it's insaturated
    MB_molecule_to_create_monomer = Alcohol(chain_length=2), # Mbuild compound, ethanol molecule
    fetch_compound_from_database = False,
    first_port_monomer = "COH",
    ...
    polymer_backbone_target = {
                            "anchor_atom" : "O",
                            "target_atom" : "H",
                            "anchor_atom_n_bonds" : 2,
                            }
    
    if crosslinker_name == "Glutaraldehyde":
                            
        crosslinker_backbone_target = {
                                "anchor_atom" : "C",
                                "target_atom" : ["H", "O"],
                                "anchor_atom_n_bonds" : 3,
                                "extra_pruning": [],
    ...
    elif crosslinker_name == "Dimethylolurea":
    ...
    elif crosslinker_name == "Oxalic acid":
    ...
    elif crosslinker_name == "Malic acid":
    ...
    elif crosslinker_name == "Formaldehyde":
    ...
    return Number_Crosslinkers_Used, Real_Degree_Crosslinking, Polymer_residue_name, Crosslinker_residue_name
